$(document).ready(function() {
    ...
    var answerArray = [["Andorra", "Vatican", "Monaco", "Malta"], ["Tokyo", "San Paolo", "New York","Moscow"], ["Denmark", "USA", "India", "Norway"], ["Lhotse", "K2", "Mount Everest", "Makalu"], ["Hong Kong", "Macau", "Shanghai", "Beijing"], ["Missouri River", "Mississippi River", "Yukon River", "Rio Grande"], ["Medellin", "Bogota", "Cartagena", "Cali"], ["Dead Sea", "Great Salt Lake","Lake Baikal","Don Juan"]];
    ...
    var correctAnswers = ["B. Vatican", "A. Tokyo", "D. Norway", "C. Mount Everest", "D. Beijing", "A. Missouri River", "B. Bogota", "D. Don Juan"];
